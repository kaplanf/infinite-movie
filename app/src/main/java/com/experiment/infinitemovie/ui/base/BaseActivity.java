...
import com.experiment.infinitemovie.di.component.DaggerActivityComponent;
import com.experiment.infinitemovie.di.module.ActivityModule;
import com.experiment.infinitemovie.util.CommonUtils;
...
public abstract class BaseActivity extends AppCompatActivity
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mActivityComponent = DaggerActivityComponent.builder()
                ...
                .applicationComponent(((InfiniteMovieApplication) getApplication()).getComponent())
                .build();
